...
当前开发环境使用 `3306/kerthus_saas`：包含 62 个账号、45 个租户、3567 条地区数据及完整的组织、角色关系。开发启动用 `make dev`，使用已配置账号登录；不要重复初始化默认种子。数据准备、备份和导入流程见 [数据迁入说明](docs/migration/legacy-data-import.md)。
