<template>
  <div>
    <BasicTable @register="registerTable" :searchInfo="searchInfo">
      ...
      <template #toolbar>
        <a-button
          v-auth="['system:tenant:detail:employee:create']"
          type="primary"
          @click="handleCreate"
        >
          新增
            ...
            :actions="[
              {
                ...
                ifShow: hasPermission(['system:tenant:detail:employee:edit']),
              },
              {
                icon: 'ant-design:interaction-outlined',
                color: 'error',
                ifShow: hasPermission(['system:tenant:detail:employee:resetPassword']),
    ...
    <EmployeeForm @register="registerDrawer" @success="handleSuccess" :fetchParams="fetchParams" />
  </div>
</template>
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const searchInfo = reactive<Recordable>({ tenant_id: props.fetchParams.id });
      ...
      const [registerTable, { reload }] = useTable({
        ...
        actionColumn: {
          ...
          ifShow: hasPermission([
            'system:tenant:detail:employee:edit',
            'system:tenant:detail:employee:resetPassword',
          ]),
        },
      });
