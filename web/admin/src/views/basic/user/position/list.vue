<template>
  <div>
    <BasicTable @register="registerTable" :searchInfo="searchInfo">
      ...
      <template #toolbar>
        <a-button v-auth="['basic:user:position:create']" type="primary" @click="handleCreate">
          新增
        </a-button>
      </template>
            ...
            :actions="[
              {
                ...
                ifShow: hasPermission(['basic:user:position:edit']),
              },
              {
                icon: 'ant-design:delete-outlined',
                color: 'error',
                ifShow: hasPermission(['basic:user:position:delete']),
                popConfirm: {
                  title: '是否确认删除',
                  placement: 'left',
    ...
    setup(props) {
      ...
      const [registerTable, { reload }] = useTable({
        ...
        actionColumn: {
          ...
          dataIndex: 'action',
          fixed: undefined,
          ifShow: hasPermission(['basic:user:position:edit', 'basic:user:position:delete']),
        },
      });
