...
<script lang="ts">
  ...
  import { defineComponent, reactive, ref, shallowRef, computed, unref, onMounted, watch, nextTick } from 'vue';
  ...
  export default defineComponent({
    ...
    setup(props, { emit, attrs }) {
      ...
      const propsRef = shallowRef<Partial<FormProps>>({});
...
<style lang="less">
  @prefix-cls: ~'@{system-prefix}-basic-form';
